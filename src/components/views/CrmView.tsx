                ...
                <tbody>
                  {lote.map((r) => (
                    ...
                    >
                      ...
                      <td className="px-4 py-3 text-[var(--color-text-muted)]">
                        <EnvioBadges
                          mailEnviado={r.mailEnviado}
                          mailEnviadoEn={r.mailEnviadoEn}
                          whatsappEnviado={r.whatsappEnviado}
                          whatsappEnviadoEn={r.whatsappEnviadoEn}
                          whatsappSinWa={r.whatsappSinWa}
                          llamadaRealizada={r.llamadaRealizada}
                          llamadaRealizadaEn={r.llamadaRealizadaEn}
                        />
                      </td>
